...
Project:    Assignment#2 - Creating simple query to extract data
                           Using SELECT Statement and ORDER BY(Sorting).             
Name:       Christopher Singleton 
Class:      BUSIT 103 - Online
...
SELECT * FROM [SalesLT].[Product] --SHOULD BE THIS INSTEAD OF LISTING EVERY COLUMN.
...
SELECT [ProductID], 
	   ...
	   [ProductCategoryID]
FROM [SalesLT].[Product]
ORDER BY [ProductCategoryID] ASC, [ProductNumber] ASC
...
--119 distinct product model IDs in table Product
...
SELECT * FROM [SalesLT].[Address]--SHOULD BE THIS INSTEAD OF LISTING ALL THE COLUMNS.
...
SELECT DISTINCT [City], 
				...
				[PostalCode]
FROM [SalesLT].[Address]
ORDER BY [CountryRegion] ASC, [StateProvince] ASC, [City] ASC
...
SELECT DISTINCT [StateProvince], 
                [CountryRegion] 
FROM [SalesLT].[Address] 
ORDER BY [CountryRegion] ASC, [StateProvince] ASC
...
/* NOTES:
Hi Art, Please find the attachment for Assignment #2. Thank you, Christopher Singleton
Chris Singleton, Oct 2 at 9:06pm

Nice job on this Chris! Make sure you type out all your SQL key words in caps; for example 
"Select" as "SELECT". It will work either way, but the best practice is to use all caps :-) - 
#5, you can just do SELECT * rather than listing all the fields. - 
#8 should be pulling from the ProductModel table - 
#10 can also be SELECT * rather than listing all the fields.
Art Lovestedt, Oct 8 at 1:21pm

Art, Thank you for letting me know how you want it and where I was going wrong. 
Yes, you are right! I created more work for myself, but I really enjoyed learning this. 
I have corrected the original and will continue to review it. Thank you once again! 
This really helps me to learn! Chris
Chris Singleton, Oct 8 at 9:24pm
*/